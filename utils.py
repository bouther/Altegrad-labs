...
Original file is located at
    https://colab.research.google.com/drive/1Lgi8YAmeImtUYfexA2vt-xOotskl6LkC

<br>
Graph-based Recommentations - ALTEGRAD - Jan 2022<br>
"""
...
def load_dataset():
    with open('/content/diginetica_train.p', 'rb') as f:
        data_train = pickle.load(f)
    sessions_train = data_train[0][:50000]
    y_train = np.array(data_train[1][:50000])
    with open('/content/diginetica_test.p', 'rb') as f:
    ...
    print('Number of test sessions:', len(sessions_test))
    ...
    print('Maximum item id:', max_item_id )
